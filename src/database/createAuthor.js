...
async function createAuthorUser(username, email, password) {
  const insertAuthorUserQuery = `INSERT INTO users (username, email, password, is_premium, is_author) VALUES ($1, $2, $3, $4, $5) RETURNING id, username, email, is_author;`;
  ...
  try {
    ...
    throw new Error("Error creating author user");
  }
}
